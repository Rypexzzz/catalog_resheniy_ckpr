...
<head>
  ...
  <title>Виджет «Прогноз погоды»</title>
...
<div class="ckpr-product-page">
  ...
  <section class="ckpr-hero">
    <div class="ckpr-hero-content">
      <h1 class="ckpr-hero-title">Виджет «Прогноз погоды»</h1>
      <p class="ckpr-hero-desc">Виджет на главной странице корпоративного портала, отображающий текущую погоду и прогноз на ближайшие дни для местоположения пользователя</p>
      <a href="/upload/catalog_resheniy_ckpr_presentations/weather-widget.pdf" class="ckpr-btn" onclick="top.BX.SidePanel.Instance.open(this.href, {cacheable: false}); return false;">Презентация о продукте</a>
    </div>
    <div class="ckpr-hero-logo">
      <img src="/upload/catalog_resheniy_ckpr_icons/logo-weather-widget.png" alt="Виджет «Прогноз погоды»">
    </div>
  </section>
    ...
    <div class="ckpr-capabilities">
      <div class="ckpr-capability">
        <div class="ckpr-capability-header">
          ...
          <div class="ckpr-capability-title">Отображение погоды</div>
        </div>
        <ul class="ckpr-capability-list">
          <li>Текущая температура, облачность, осадки и ветер</li>
          <li>Прогноз на ближайшие дни</li>
      ...
      <div class="ckpr-capability">
        <div class="ckpr-capability-header">
          ...
          <div class="ckpr-capability-title">Настройка виджета</div>
        </div>
        <ul class="ckpr-capability-list">
          <li>Выбор города вручную</li>
          <li>Настройка единиц измерения</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <section class="ckpr-section">
    ...
    <div class="ckpr-specs">
      ...
      <div class="ckpr-spec">
        ...
        <div class="ckpr-spec-value">PHP, JS, REST API</div>
      </div>
      <div class="ckpr-spec">
        <div class="ckpr-spec-label">Интеграции</div>
        <div class="ckpr-spec-value">RusMeteo</div>
      </div>
    </div>
  </section>
    ...
    <div class="ckpr-advantages">
      <ul class="ckpr-advantages-list">
        <li>
          ...
          Актуальная информация о погоде без перехода на сторонние сервисы
        </li>
        <li>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>
          Полезный элемент главной страницы для планирования рабочего дня и командировок
        </li>
        <li>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>
          Использование отечественного сервиса RusMeteo
        </li>
      </ul>
    </div>
  </section>
