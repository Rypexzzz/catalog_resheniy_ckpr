...
<div class="ckpr-section">
  <div class="ckpr-header">
    <h1 class="ckpr-title">Решения для разработки</h1>
    <p class="ckpr-subtitle">Усовершенствуйте процесс разработки с помощью наших кастомных решений</p>
  </div>
