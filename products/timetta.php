...
<head>
  ...
  <title>Модуль интеграции с ИСУП Тиметта</title>
...
<div class="ckpr-product-page">
  ...
  <section class="ckpr-hero">
    <div class="ckpr-hero-content">
      <h1 class="ckpr-hero-title">Модуль интеграции с ИСУП Тиметта</h1>
      <p class="ckpr-hero-desc">Модуль для автоматизации обмена данными между корпоративным порталом и информационной системой управления проектами в части ресурсного планирования и управления вакансиями</p>
      <a href="/upload/catalog_resheniy_ckpr_presentations/timetta.pdf" class="ckpr-btn" onclick="top.BX.SidePanel.Instance.open(this.href, {cacheable: false}); return false;">Презентация о продукте</a>
    </div>
    <div class="ckpr-hero-logo">
      <img src="/upload/catalog_resheniy_ckpr_icons/logo-timetta.png" alt="Модуль интеграции с ИСУП Тиметта">
    </div>
  </section>
    ...
    <div class="ckpr-capabilities">
      <div class="ckpr-capability">
        <div class="ckpr-capability-header">
          ...
          <div class="ckpr-capability-title">Интеграция запросов на ресурсы</div>
        </div>
        <ul class="ckpr-capability-list">
          <li>Автоматическая передача запросов на выделение ресурсов из ИСУП в раздел ресурсного планирования КИС</li>
          <li>Синхронизация статусов запросов между системами</li>
        </ul>
      </div>
      <div class="ckpr-capability">
        <div class="ckpr-capability-header">
          ...
          <div class="ckpr-capability-title">Управление вакансиями</div>
        </div>
        <ul class="ckpr-capability-list">
          <li>Автоматическое создание вакансий в КИС на основе запросов в статусе «Вакансия» из ИСУП</li>
          <li>Поддержка категорий: производственный персонал и АУП</li>
          <li>Прохождение этапов согласования вакансии в КИС</li>
        </ul>
      </div>
      <div class="ckpr-capability">
        <div class="ckpr-capability-header">
          ...
          <div class="ckpr-capability-title">Закрытие вакансий</div>
        </div>
        <ul class="ckpr-capability-list">
          <li>Отражение информации о подобранном сотруднике</li>
          <li>Синхронизация закрытия вакансии между КИС и ИСУП</li>
          <li>Подтверждение выделенного ресурса руководителем проекта</li>
        </ul>
      </div>
      <div class="ckpr-capability">
        <div class="ckpr-capability-header">
          ...
          <div class="ckpr-capability-title">Ассистент по бронированию</div>
        </div>
        <ul class="ckpr-capability-list">
          <li>Поиск свободных ресурсов по заданным критериям</li>
          <li>Отражение нового сотрудника в запросе на ресурс</li>
        </ul>
      </div>
    </div>
  </section>
  ...
  <section class="ckpr-section">
    ...
    <div class="ckpr-specs">
      ...
      <div class="ckpr-spec">
        ...
        <div class="ckpr-spec-value">PHP, REST API</div>
      </div>
      <div class="ckpr-spec">
        <div class="ckpr-spec-label">Интеграции</div>
        <div class="ckpr-spec-value">ИСУП Тиметта</div>
      </div>
    </div>
  </section>
    ...
    <div class="ckpr-advantages">
      <ul class="ckpr-advantages-list">
        <li>
          ...
          Единое информационное пространство для управления ресурсами и вакансиями
        </li>
        <li>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>
          Автоматическая синхронизация данных между КИС и ИСУП — исключение ручного переноса информации
        </li>
        <li>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>
          Сокращение времени на обработку запросов на ресурсы
        </li>
        <li>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>
          Прозрачный процесс согласования вакансий с отслеживанием статусов
        </li>
        <li>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>
          Поддержка различных категорий персонала (АУП и производственный персонал)
        </li>
        <li>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 6L9 17l-5-5"/></svg>
          Интеграция с Ассистентом по бронированию для быстрого подбора ресурсов
        </li>
      </ul>
    </div>
  </section>
